...
function Steps() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3  max-w-[1200px] justify-center gap-[30px] items-center mx-auto my-20">

      <div className="card bg-white shadow-md max-w-[250px] lg:max-w-[300px] mx-auto space-y-3">
      ...
      <div className="card bg-white shadow-md max-w-[250px] lg:max-w-[300px] mx-auto space-y-3">
        ...
        <div className="card-body text-center  ">
          ...
          <p className="text-[16px] text-[#627382]">Browse our catalog and select the toolsthat fit your needs.</p>
        </div>
      </div>
      <div className="card bg-white shadow-md max-w-[250px] lg:max-w-[300px] mx-auto space-y-3">
        <div className="relative">
